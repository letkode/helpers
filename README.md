...
## 📂 [Validación](./Validation/README.md)
...
- **[Ver detalle de funciones y parámetros →](./Validation/README.md)**

---

## 📂 [Conversión](./Conversion/README.md)
...
- **[Ver detalle de funciones y parámetros →](./Conversion/README.md)**
...
- **[Ver detalle de funciones y parámetros →](./String/README.md)**
...
- **[Ver detalle de funciones y parámetros →](./Array/README.md)**
...
- **[Contratos y Interfaces](./Contract/README.md)**: Definición técnica de las interfaces `HelperInterface`.
